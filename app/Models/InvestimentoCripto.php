...
class InvestimentoCripto extends Model
{
    ...
    public function compras() {
        return $this->hasMany(InvestimentoCriptoCompra::class, 'id_investimento', 'id')->where('ativo', 1);
    }

    public function vendas() {
        return $this->hasMany(InvestimentoCriptoVenda::class, 'id_investimento', 'id')->where('ativo', 1);
    }
