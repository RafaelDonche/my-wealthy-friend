...
@section('content')
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="float-end div-btns" nome="{{ $item->ativo_info->sigla . ' - ' . $item->ativo_info->nome }}"
                            ...
                            <a class="btn btn-sm btn-action my-1"
                                rota="{{ route('carteira.acao.compra.store', $item->id) }}"
                                onclick="abrirModalComprar(this)">Comprar</a>
                            <a class="btn btn-sm btn-action my-1"
                                rota="{{ route('carteira.acao.venda.store', $item->id) }}"
                                onclick="abrirModalVender(this)">Vender</a>
                            <a class="btn m-1" rota="{{ route('carteira.acao.destroy', $item->id) }}"
                                        ...
                                        @foreach ($item->vendas as $v)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a rota="{{ route('carteira.acao.venda.update', $v->id) }}"
                                                        onclick="abrirModalEditarVenda(this)" class="pointer"><i class="fas fa-pen"></i></a>

                                                    {{-- <a rota="{{ route('carteira.acao.venda.destroy', $v->id) }}"
    ...
    @include('carteira.investimento-acao.home-modals')
