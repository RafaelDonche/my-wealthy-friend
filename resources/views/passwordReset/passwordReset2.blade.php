        ...
        <div class="card-body pt-0">
            <form action="{{ route('passwordReset4', Crypt::encrypt($user->id)) }}" method="POST" id="form">
                ...
                <div class="m-sm-4">
                    ...
                    <div class="mb-3">
                        <label for="password">Informe a nova senha (minímo 6 e máximo 16 caracteres)</label>
                        <input type="password" name="password" id="password" class="form-control form-control-lg"
                            placeholder="Informe a nova senha">
                    </div>
                    <div class="mb-3">
                        <label for="confirmacao">Confirme a senha</label>
                        <input type="password" name="confirmacao" id="confirmacao" class="form-control form-control-lg"
                            placeholder="Confirme a senha">
                    </div>
                    <div class="text-center mt-3">
                        <button type="submit" class="btn btn-lg btn-primary" style="width: 100%">Alterar</button>
                    </div>
